...
`(GMT-06:00) Hora central - Ciudad de México`.
...
```json
{"ok":true,"servicio":"PillTime API","zonaHoraria":"America/Mexico_City",
...
| `hora_programada` sale como `Sat Dec 30 1899` | Google Sheets convirtió el texto en hora. Escribe `'08:00` con apóstrofo |
